...
export default function GuideDetailPage() {
  ...
  if (!guide) {
    return (
      <div className="text-center py-12">
        ...
        <Link href={`/${locale}/creator/guides`}>
          <Button variant="outline" size="sm" className="mt-4">가이드 목록으로</Button>
        </Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <Link href={`/${locale}/creator/guides`} className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground mb-4">
