...
import { Package, Truck, ChevronRight, Loader2, User, MessageCircle, Star, ShoppingBag, RotateCcw } from 'lucide-react';
...
export default function GlobalOrdersListPage() {
  ...
  if (!isUserLoading && !user) {
    return (
      <div className="max-w-lg mx-auto px-4 py-16 text-center">
        ...
        <Link
          href={`/${locale}/buyer/login?returnUrl=${encodeURIComponent(`/${locale}/my/orders`)}`}
                      ...
                      >
                        ...
                        <div className="mt-3 pt-3 border-t border-gray-50">
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            <Link href={`/${locale}/my/orders/${order.id}`}>
                            ...
                            {['PAID', 'PREPARING', 'SHIPPING'].includes(order.status) && (
                              <Link href={`/${locale}/my/orders/${order.id}/inquiry`}>
                                <Button variant="outline" size="sm" className="text-xs h-8 gap-1 rounded-full">
                            ...
                            {['DELIVERED', 'CONFIRMED'].includes(order.status) && (
                              <>
                                <Link href={`/${locale}/my/orders/${order.id}/review/write`}>
                                  <Button variant="outline" size="sm" className="text-xs h-8 gap-1 rounded-full">
